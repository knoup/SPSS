...
namespace spss {
	...
	class InfoBox : public sf::Drawable {
	  public:
		...
		////////////////////////////////////////////////////////////
		/// \brief Calls the scrollbar's setAnchor() function
		///
		/// \param _a The anchor type
		///
		////////////////////////////////////////////////////////////
		void setAnchor(Scrollbar::Anchor _a);

		////////////////////////////////////////////////////////////
		/// \brief Calls the scrollbar's getAnchor() function
		///
		////////////////////////////////////////////////////////////
		Scrollbar::Anchor getAnchor() const;
